...
- Rounded up numerical value decimal points to hundredths place for columns: TotalDistance, TrackerDistance, LoggedActivitiesDistance, VeryActiveDistance, ModeratelyActiveDistance, LightActiveDistance, and SedentaryActiveDistance
- Identified duplicates by ID and date, then deleted "4.12.16" datapoints from the "dailyActivity_merged 3.12.16-4.11.16" dataset
